    ...
    <section className="py-16 md:py-32 px-6 relative z-10" id="about">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8">
        ...
        <div className="md:col-span-4 flex flex-col gap-12">
          ...
          >
            <h3 className="text-sm font-bold tracking-widest text-white/60 uppercase mb-6">Formação</h3>
            <ul className="space-y-4">
              <li className="text-white/90 font-medium">Mecatrônica <span className="text-white/60 ml-2">SENAI CIMATEC</span></li>
              <li className="text-white/90 font-medium">Análise e Desenv. de Sistemas <span className="text-white/60 ml-2">UCSAL</span></li>
            </ul>
          </motion.div>
          ...
          >
            <h3 className="text-sm font-bold tracking-widest text-white/60 uppercase mb-6">Tecnologias</h3>
            <div className="grid grid-cols-2 gap-3">
              {skills.map((skill, index) => (
                <div key={index} className="flex items-center gap-2 sm:gap-3 text-xs sm:text-sm text-white/85 bg-white/5 border border-white/10 rounded-lg p-2.5 sm:p-3">
        ...
        <div className="md:col-span-8 flex flex-col justify-center">
          ...
          <motion.div 
            ...
            className="mt-16"
          >
            <LiquidCard className="p-6 md:p-8 flex flex-row items-center gap-6 md:gap-8 max-w-md w-full">
              <span className="text-6xl md:text-8xl font-black text-white tracking-tighter">100<span className="text-blue-500">%</span></span>
              <span className="text-base md:text-lg text-white/80 max-w-[150px] leading-tight font-medium">Focado em performance e qualidade.</span>
            </LiquidCard>
          </motion.div>
        </div>
