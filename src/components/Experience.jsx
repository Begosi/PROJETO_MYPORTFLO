    ...
    <section className="py-32 px-6 relative z-10" id="experience">
      <div className="max-w-5xl mx-auto">
        <motion.h2 
          ...
          className="text-4xl md:text-6xl font-bold tracking-tight text-white mb-24"
        >
          Experiência.
        </motion.h2>
            ...
            {experiences.map((exp, index) => (
              ...
              >
                ...
                <div className="col-span-1 md:text-right md:pr-12">
                  <span className="text-sm font-bold tracking-widest text-white/40 uppercase block mb-2">{exp.period}</span>
